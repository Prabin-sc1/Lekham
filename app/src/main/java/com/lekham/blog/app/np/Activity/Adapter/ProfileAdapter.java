...
public class ProfileAdapter extends FirebaseRecyclerAdapter<Blog, ProfileAdapter.PostViewHolder> {

    public ProfileAdapter(@NonNull @NotNull FirebaseRecyclerOptions<Blog> options) {
        super(options);
    }
