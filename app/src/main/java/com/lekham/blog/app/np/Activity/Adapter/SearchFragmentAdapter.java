...
public class SearchFragmentAdapter extends FirebaseRecyclerAdapter<Blog, SearchFragmentAdapter.PostViewHolder> {

    public SearchFragmentAdapter(@NonNull @NotNull FirebaseRecyclerOptions<Blog> options) {
        super(options);
    }
